...
class Student:
    ...
    def __init__(self, student_id=None, first_name=None, last_name=None, gender=None, year=None, course_id=None):
        self.id = id
    ...
    @classmethod
    def is_unique(cls, student_id, first_name, last_name, gender, year, course_id):
